...
Requires Python 3.6+ and discord.py async (0.16).
"""
...
async def on_message(message):
    ...
    async def send_message(text):
        """An abstracted send function for callback_send."""
    ...
    try:
        await bot.process(message.content, is_owner=is_owner, callback_send=send_message,
